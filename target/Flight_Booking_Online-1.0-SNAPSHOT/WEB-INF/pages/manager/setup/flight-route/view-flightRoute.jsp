                                ...
                                <div class="table-scrollable">
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <c:forEach items="${flightRoutes}" var="f">
                                            <tbody>
                                            <tr class="odd gradeX">
                                                <td class="center">${f.departure.airportName}</td>
                                                <td class="center">${f.destination.airportName}</td>
                                                <td class="center">${f.distance}</td>
                                                <td class="center">
                                                    <fmt:formatDate type = "time" value = "${f.duration}" />
                                                </td>
                                                <td class="center">${f.price}</td>
                                                <td class="center">
                                                    <a href="<c:url
                                                    ...
                                                    <button onclick="location.href='<c:url value="/manager/airport/delete/${f.id}"/>'" class="btn btn-tbl-delete btn-xs">
